#!/usr/bin/env bash
# The dependency test every build gets: install the .deb into a clean Debian container, sweep every
...
echo "installed:"; dpkg -s tuxflix | grep -E "^(Version|Installed-Size)"
