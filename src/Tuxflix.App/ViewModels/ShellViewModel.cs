...
public sealed partial class ShellViewModel : ObservableObject
{
    ...
    // Each feature follows the open server from a file of its own: marks and live news, downloads.
    partial void OnSessionChanged(ServerSession? oldValue, ServerSession? newValue)
    {
        ViewerFollowsSession(oldValue, newValue);
        DownloadsFollowSession(oldValue, newValue);
    }
